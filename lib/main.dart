      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(dollarTextField),
            TextField(EuroTextField),
            ElevatedButton(onPressed_dollars = double.parse(dollarTextField.text), child: Text("Convert to Euros")),
            ElevatedButton(onPressed_dollars = double.parse(dollarTextField.text), child: Text("Convert to Dollars"))
          ],
        ),
      ),
